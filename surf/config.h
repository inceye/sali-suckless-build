...
static char *dldir          = "~/Downloads/Surf/";
...
static SearchEngine searchengines[] = {
	...
	{ "od",		"https://www.oxfordlearnersdictionaries.com/definition/english/%s?q=%s"	},
	{ "cd", 	"https://dictionary.cambridge.org/dictionary/english/%s"},
	{ "pb",		"https://thehiddenbay.com/search/%s"			},
	{ "ytm",	"https://music.youtube.com/search?q=%s"			},
	{ "gh",		"https://github.com/search?q=%s"			},
	{ "wp",		"https://wallpapercave.com/search?q=%s"			},
	{ "al",		"https://wiki.archlinux.org/index.php?search=%s"	},
};
...
"prop=\"`tac ~/.surf/history.txt | dmenu -l 10 -i -w $1 | cut -d ' ' -f 3`\" &&" \
